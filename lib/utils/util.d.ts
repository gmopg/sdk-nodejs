...
export declare var METHOD_LUMP: string;
export declare var METHOD_INSTALLMENT: string;
export declare var METHOD_BONUS_LUMP: string;
export declare var METHOD_REVOLVING: string;
export declare var METHOD_BONUS_INSTALLMENT: string;
